...
class TestScenario:
    ...
    @pytest.mark.parametrize(
        ...
        [
            ...
            (
                ...
                {
                    "aircraftSpeed": 1.0,
                    "targetReflectance": 1.0,
                    "targetTemperature": 1.0,
                    "backgroundReflectance": 1.0,
                    "backgroundTemperature": 1.0,
                    "haWindspeed": 1.0,
                    "cn2at1m": 1.0,
                },
            ),
    ...
    def test_initialization(
        self, name: str, ihaze: int, altitude: float, ground_range: float, other_args: Dict[str, float]
    ) -> None:
        """
    ...
    def test_atm_index_error(self, name: str, ihaze: int, altitude: float, ground_range: float) -> None:
        """
    ...
    def test_atm(self, name: str, ihaze: int, altitude: float, ground_range: float, expected: np.ndarray) -> None:
        """
